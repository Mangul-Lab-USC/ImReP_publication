...
To extract CDR3s from each of the chains we use IgBLAST's included Python [script](https://github.com/nbstrauli/influenza_vaccination_project/blob/master/scripts/pipeline/parse_igblast_output.py):
```
python parse_igblast_output.py [path_to_IgBLAST_output_file] [path_to_parse_output_file]
```
